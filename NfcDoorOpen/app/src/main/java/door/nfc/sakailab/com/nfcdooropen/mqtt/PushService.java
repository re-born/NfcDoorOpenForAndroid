...
public class PushService extends Service {
    ...
    public static String MQTT_CLIENT_ID = "nfcdoor";
    ...
    private static final String ACTION_PUBLISH_MESSAGE = MQTT_CLIENT_ID + ".PUBLISH";
    ...
    private static final String SERVER_HOST = "taishonet.com";
    ...
    public static void actionStart(Context ctx, String topic) {
        mTopicName = topic;
    ...
    public static void actionPublish(Context ctx) {
        Intent i = new Intent(ctx, PushService.class);
        i.setAction(ACTION_PUBLISH_MESSAGE);
        ctx.startService(i);
    }
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent.getAction().equals(ACTION_STOP)) {
            try {
                if (mConnection != null) {
                    mConnection.unsubscribeToTopic(mTopicName);
                    Toast.makeText(this, "Unsubscribe: " + mTopicName, Toast.LENGTH_SHORT).show();
                }
        ...
        } else if (intent.getAction().endsWith(ACTION_PUBLISH_MESSAGE)) {
            publishMessage();
        }
    ...
    private synchronized void connect() {
        ...
        mExecutor.submit(new Runnable() {
            ...
            public void run() {
                try {
                    mConnection = new MQTTConnection(SERVER_HOST, mTopicName);
                } catch (MqttException e) {
    ...
    private class MQTTConnection implements MqttSimpleCallback {
        ...
        private final String clientID = "android/" + System.currentTimeMillis();
